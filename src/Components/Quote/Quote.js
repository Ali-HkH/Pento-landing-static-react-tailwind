...
function Quote() {
  return (
    <div className='relative bg-emerald-500 text-white z-10 pt-5 md:py-[50px] xl:pt-5 xl:pb-0'>
        {/* shape 1 */}
        <div className='absolute w-[250px] bottom-0 right-0 opacity-50 -z-10 hidden lg:block'>
            <img src="./imgs/shape-1.png" alt="shape" />
        </div>
        {/* shape 2 */}
        <div className='absolute top-5 left-10 hidden -z-10 lg:block'>
            ...
            <div className='flex flex-col gap-y-6 items-start justify-center md:flex-row md:items-center  pt-5'>
                <div className='px-3'>
                    <div className="text-right mb-6">
                        <span className="mb-[18px] inline-block text-sm lg:text-base lg:font-Dana-med">دریافت یک نقل قول</span>
                        <h1 className="text-2xl lg:text-[40px]/[46px] font-Dana-bold">اگر شک دارید قیمت وام مسکن را دریافت کنید</h1>
                    </div>
                    <div className='flex gap-x-8 text-sm lg:text-base child:transition-colors'>
