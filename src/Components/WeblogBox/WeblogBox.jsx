...
function WeblogBox({ img, name, date, title }) {
   return (
      <div className="p-8 mb-8 bg-slate-100 dark:bg-about">
         ...
         <div className="mb-5 flex items-center justify-start gap-x-2">
            ...
            <span className="text-xs md:text-sm text-gray-500 dark:text-white pl-3">
               {name}
            </span>
            <svg className="text-emerald-500 size-4">
               <use href="#calendar"></use>
            </svg>
            <span className="text-xs md:text-sm text-gray-500 dark:text-white">
               {date}
            </span>
         </div>
         <h1 className="text-xl lg:text-[22px]/[28px] text-zinc-800 dark:text-white mb-4 line-clamp-2">
            {title}
         </h1>
         <p className="text-gray-500 dark:text-white line-clamp-4 ">
